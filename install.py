...
class Installer(object):
    def __init(self, config_path="./config_json"):
    ...
    def load_config(self):
        ...
        try:
            ...
            self.plist_file_name = config['lable'] + ".plist"
            return config

    def mprint(log, level="info"):
        print("\n","*"*10, log, "*"*10, "\n")
        if level == "info":
            logging.info(log)
        elif level == "error":
    ...
    def generate_plist(self):
        ...
        plist_content = {
            ...
            'StandardErrorPath': _config['logs']['stdout'],
            'StandardOutPath': _config['logs']['stderr'],
            'StartInterval': _config['download_interval']
        }
